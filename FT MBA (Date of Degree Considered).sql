...
Would you please pull the following fields for all full-time MBA alumni who graduated between 10/1/14 – 9/30/17? This data will support the alumni survey.
o  Entity ID
o  EMPL ID
o  First Name
o  Last Name
...
Found the department codes in CATracks against Paul's degree view 

FT Not Applying to this ad hoc: 

FT-EB = Not Offered in 2014 -2017  - These are the defunct kellogg programs (before 1970)
FT-CB = Not offered in 2014 - 2017. - These are the defunct kellogg programs (before 1970)
FT-MMGT = Ask Paul - I don't think it should be in the code since MMGT was a long time ago
FT = Ask Paul
FT-MBAi - Not offered from 2014 - 2017 

FT Programs Applying to this ad hoc: 

FT-1Y = 01KGS1Y - 1Y MBA
FT-2Y = 01KGS2Y - 2Y MBA 
FT-MS = 01MMS - MS in Management Studies
FT-JDMBA  = 13JDM - JDMBA
FT-MDMBA  = '01MDB' - 'MDMBA'
FT-MMM = 01MMM - MMM program
FT-KENNEDY = 01KEN - Kennedy Program 
