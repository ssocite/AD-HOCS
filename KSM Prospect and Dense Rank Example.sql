...
--- KSM Prospect as my base - Just in case we want to pull non-ksm alumni
--- I want to pull anyone with at least one active address in  Florida
--- Let's use my v all address view
With h as (Select
h.id_number,
       h.REPORT_NAME,
       h.SPOUSE_ID_NUMBER,
